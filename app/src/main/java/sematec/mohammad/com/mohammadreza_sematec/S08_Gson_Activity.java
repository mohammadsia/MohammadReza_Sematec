...
public class S08_Gson_Activity extends AppCompatActivity implements View.OnClickListener {

    Button btn_getPray;
    TextView txt_Pray_Data,txt_City_Name;
    EditText edt_Pray;
    private String Api_Url, Api_UrlCity_Name,Pry_Fajr,Pry_Sunrise,Pry_Dhuhr,Pry_Asr,Pry_Sunset,Pry_Maghrib
            ,Pry_Isha,Pry_Imsak,Pry_Midnight;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_s08__gson_);
